...
import 'rvistor5_model.dart';
export 'rvistor5_model.dart';
...
class Rvistor5Widget extends StatefulWidget {
  const Rvistor5Widget({super.key});

  static String routeName = 'rvistor5';
  static String routePath = '/rvistor5';

  @override
  State<Rvistor5Widget> createState() => _Rvistor5WidgetState();
}

class _Rvistor5WidgetState extends State<Rvistor5Widget> {
  late Rvistor5Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Rvistor5Model());
