...
import 'rrr5_model.dart';
export 'rrr5_model.dart';
...
class Rrr5Widget extends StatefulWidget {
  const Rrr5Widget({super.key});

  static String routeName = 'rrr5';
  static String routePath = '/rrr5';

  @override
  State<Rrr5Widget> createState() => _Rrr5WidgetState();
}

class _Rrr5WidgetState extends State<Rrr5Widget> {
  late Rrr5Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Rrr5Model());
