...
import 'log_in_page_org_model.dart';
export 'log_in_page_org_model.dart';

class LogInPageOrgWidget extends StatefulWidget {
  const LogInPageOrgWidget({super.key});

  static String routeName = 'LogInPageOrg';
  static String routePath = '/logInPageOrg';

  @override
  State<LogInPageOrgWidget> createState() => _LogInPageOrgWidgetState();
}

class _LogInPageOrgWidgetState extends State<LogInPageOrgWidget> {
  late LogInPageOrgModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => LogInPageOrgModel());
                          ...
                          FFButtonWidget(
                            onPressed: () async {
                              ...
                              context.pushNamedAuth(
                                  OrganizerWidget.routeName, context.mounted);
                            },
