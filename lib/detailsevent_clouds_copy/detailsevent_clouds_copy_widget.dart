...
import 'detailsevent_clouds_copy_model.dart';
export 'detailsevent_clouds_copy_model.dart';

class DetailseventCloudsCopyWidget extends StatefulWidget {
  const DetailseventCloudsCopyWidget({super.key});

  static String routeName = 'DetailseventCloudsCopy';
  static String routePath = '/detailseventCloudsCopy';

  @override
  State<DetailseventCloudsCopyWidget> createState() =>
      _DetailseventCloudsCopyWidgetState();
}

class _DetailseventCloudsCopyWidgetState
    extends State<DetailseventCloudsCopyWidget> {
  late DetailseventCloudsCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DetailseventCloudsCopyModel());
