...
import 'smartfamily_model.dart';
export 'smartfamily_model.dart';
...
/// page.
class SmartfamilyWidget extends StatefulWidget {
  const SmartfamilyWidget({super.key});

  static String routeName = 'smartfamily';
  static String routePath = '/smartfamily';

  @override
  State<SmartfamilyWidget> createState() => _SmartfamilyWidgetState();
}

class _SmartfamilyWidgetState extends State<SmartfamilyWidget> {
  late SmartfamilyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SmartfamilyModel());
