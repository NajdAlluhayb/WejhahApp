...
import 'smartwife_model.dart';
export 'smartwife_model.dart';
...
/// page.
class SmartwifeWidget extends StatefulWidget {
  const SmartwifeWidget({super.key});

  static String routeName = 'smartwife';
  static String routePath = '/smartwife';

  @override
  State<SmartwifeWidget> createState() => _SmartwifeWidgetState();
}

class _SmartwifeWidgetState extends State<SmartwifeWidget> {
  late SmartwifeModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SmartwifeModel());
