...
import 'smartalula_model.dart';
export 'smartalula_model.dart';
...
/// page.
class SmartalulaWidget extends StatefulWidget {
  const SmartalulaWidget({super.key});

  static String routeName = 'smartalula';
  static String routePath = '/smartalula';

  @override
  State<SmartalulaWidget> createState() => _SmartalulaWidgetState();
}

class _SmartalulaWidgetState extends State<SmartalulaWidget> {
  late SmartalulaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SmartalulaModel());
