...
import 'smartadven_model.dart';
export 'smartadven_model.dart';
...
/// page.
class SmartadvenWidget extends StatefulWidget {
  const SmartadvenWidget({super.key});

  static String routeName = 'smartadven';
  static String routePath = '/smartadven';

  @override
  State<SmartadvenWidget> createState() => _SmartadvenWidgetState();
}

class _SmartadvenWidgetState extends State<SmartadvenWidget> {
  late SmartadvenModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SmartadvenModel());
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      image: DecorationImage(
                        fit: BoxFit.cover,
                        image: Image.asset(
                          'assets/images/5874961790423648803.jpg',
                        ).image,
                      ),
