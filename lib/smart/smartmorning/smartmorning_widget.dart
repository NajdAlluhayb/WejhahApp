...
import 'smartmorning_model.dart';
export 'smartmorning_model.dart';
...
/// page.
class SmartmorningWidget extends StatefulWidget {
  const SmartmorningWidget({super.key});

  static String routeName = 'smartmorning';
  static String routePath = '/smartmorning';

  @override
  State<SmartmorningWidget> createState() => _SmartmorningWidgetState();
}

class _SmartmorningWidgetState extends State<SmartmorningWidget> {
  late SmartmorningModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SmartmorningModel());
