...
import 'smartchil_model.dart';
export 'smartchil_model.dart';
...
/// page.
class SmartchilWidget extends StatefulWidget {
  const SmartchilWidget({super.key});

  static String routeName = 'smartchil';
  static String routePath = '/smartchil';

  @override
  State<SmartchilWidget> createState() => _SmartchilWidgetState();
}

class _SmartchilWidgetState extends State<SmartchilWidget> {
  late SmartchilModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SmartchilModel());
