...
import 'home_page_eventbrowes_model.dart';
export 'home_page_eventbrowes_model.dart';

class HomePageEventbrowesWidget extends StatefulWidget {
  const HomePageEventbrowesWidget({
    super.key,
  ...
  static String routeName = 'HomePageEventbrowes';
  static String routePath = '/homePageEventbrowes';

  @override
  State<HomePageEventbrowesWidget> createState() =>
      _HomePageEventbrowesWidgetState();
}

class _HomePageEventbrowesWidgetState extends State<HomePageEventbrowesWidget> {
  late HomePageEventbrowesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => HomePageEventbrowesModel());
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            InkWell(
                              ...
                              onTap: () async {
                                context
                                    .pushNamed(CitysMapsBrowseWidget.routeName);
                              },
                              child: Icon(
                                Icons.location_on,
                                color: FlutterFlowTheme.of(context).primaryText,
                            ...
                            child: ClipRRect(
                              ...
                              child: Container(
                                ...
                                child: InkWell(
                                  ...
                                  onTap: () async {
                                    context.pushNamed(
                                      DetailsOceanBrowseWidget.routeName,
                                      queryParameters: {
                          ...
                          ClipRRect(
                            ...
                            child: Container(
                              ...
                              child: InkWell(
                                ...
                                onTap: () async {
                                  context.pushNamed(
                                    DetailseventAlulaBrowseWidget.routeName,
                                    queryParameters: {
                          ...
                          child: Stack(
                            children: [
                              InkWell(
                                ...
                                onTap: () async {
                                  context.pushNamed(
                                      RestaurantslistbrowesWidget.routeName);
                                },
                                child: Container(
                                  width: double.infinity,
                                  height: double.infinity,
                          ...
                          child: Stack(
                            children: [
                              InkWell(
                                ...
                                onTap: () async {
                                  context.pushNamed(
                                      SaudiCultureLISTbrowesWidget.routeName);
                                },
                                child: Container(
                                  width: double.infinity,
                                  height: double.infinity,
                          ...
                          child: Stack(
                            children: [
                              InkWell(
                                ...
                                onTap: () async {
                                  context.pushNamed(
                                      GamesListbrowesWidget.routeName);
                                },
                                child: Container(
                                  width: double.infinity,
                                  height: double.infinity,
                          ...
                          child: Stack(
                            children: [
                              InkWell(
                                ...
                                onTap: () async {
                                  context.pushNamed(
                                      ComingSoonBrowseWidget.routeName);
                                },
                                child: Container(
                                  width: double.infinity,
                                  height: double.infinity,
                          ...
                          child: Stack(
                            children: [
                              InkWell(
                                ...
                                onTap: () async {
                                  context.pushNamed(
                                      SportsListbrowesWidget.routeName);
                                },
                                child: Container(
                                  width: double.infinity,
                                  height: double.infinity,
                            ...
                            children: [
                              Align(
                                ...
                                child: InkWell(
                                  ...
                                  onTap: () async {
                                    context.pushNamed(
                                        MusicListbrowesWidget.routeName);
                                  },
                                  child: Container(
                                    width: double.infinity,
                                    height: double.infinity,
