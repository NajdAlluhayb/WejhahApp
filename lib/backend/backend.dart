...
import 'schema/eventbooking_record.dart';
...
export 'schema/eventbooking_record.dart';
...
/// Functions to query EventbookingRecords (as a Stream and as a Future).
Future<int> queryEventbookingRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      EventbookingRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );
...
Stream<List<EventbookingRecord>> queryEventbookingRecord({
  ...
  bool singleRecord = false,
    ...
    queryCollection(
      EventbookingRecord.collection,
      EventbookingRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<EventbookingRecord>> queryEventbookingRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
